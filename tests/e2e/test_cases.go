...
func nerdctlTestCases(kvmGroup ...int64) []containerTestArgs {
	...
	return []containerTestArgs{
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/nginx-cloud-hypervisor-unikraft-initrd:latest",
			Name:           "CloudHypervisor-unikraft-ping-nginx",
			Devmapper:      false,
			Seccomp:        true,
			UID:            0,
			GID:            0,
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/nginx-cloud-hypervisor-unikraft-initrd:latest",
			Name:           "CloudHypervisor-unikraft-with-seccomp",
			Devmapper:      false,
			Seccomp:        true,
			UID:            0,
			GID:            0,
